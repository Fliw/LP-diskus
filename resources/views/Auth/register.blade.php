                    ...
                    <form action="/prosesRegistrasi" method="post">
                        ...
                        <div class="card mt-5">
                            ...
                            <div class="card-body card-block">
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-8">
                                        <input type="text" id="nama" autofocus="" autocomplete="off" name="name"
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-8">
                                        <input type="email" id="hf-email" autocomplete="off" value="{{ old('email') }}"
                                            name="email" placeholder="Masukkan Email" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-4">
                                    ...
                                    <div class="col-12 col-md-8">
                                        <input type="password" id="hf-password" autocomplete="off" name="password"
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary btn-sm float-right tombol"> Gabung
                                </button>
                            </div>
                        </div>
                    </form>
