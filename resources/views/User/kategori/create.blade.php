        ...
        <div class="col-md-10">
            <form action="/kategori/create" method="post">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" name="kategori" aria-label="Default"
                        placeholder="Masukkan kategori" autofocus="" aria-describedby="inputGroup-sizing-default">
                </div>
...
<div class="modal fade" id="{{$kat->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/kategori/update/{{$kat->id}}" method="post">
                    ...
                    @method('PUT')
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" autofocus="" name="kategori" aria-label="Default"
                            value="" placeholder="Edit kategori" autofocus=""
