        ...
        <div class="col-md-10">
            <form action="/Home/tanya" method="post">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" name="judul" aria-label="Default"
                        placeholder="Judul pertanyaan" autofocus="" aria-describedby="inputGroup-sizing-default">
                </div>
                <div class="input-group mb-3">
                    <input type="text" class="form-control" name="dari" aria-label="Default" placeholder="Dari..."
                        autofocus="" aria-describedby="inputGroup-sizing-default">
                </div>
                <div class="input-group mb-3">
                ...
                <div class="form-check form-check-inline">
                    @foreach($tags as $tag)
                    <input class="form-check-input" type="checkbox" name="tag" id="inlineCheckbox1"
                        value="{{$tag->id}}">
                    <label class="form-check-label mr-3" for="inlineCheckbox1 ">{{$tag->nama}}</label>
                    @endforeach
                </div>
                <div class="input-group">
                    <textarea class="form-control" name="pertanyaan" rows="8" autofocus=""
                        placeholder="Tulis pertanyaan disini..." aria-label="With textarea"> </textarea>
                </div>
