        ...
        <img class="d-block w-100" src="{{url('asset/img/miting.jpg')}}" alt="Third slide">
         <div class="carousel-caption d-none d-md-block">
          <div class="row">
            <div class="col"> 
              <div class="col-md-12">
                <h1>Selamat Datang <span>Safitri</span>, Selamat Bergabung dengan <span>Share-Room</span>!</h1>
        ...
        <img class="d-block w-100" src="{{url('asset/img/tunjuk.jpg')}}" alt="Second slide">
         <div class="carousel-caption d-none d-md-block">
           <h1>Temukan hal baru!</h1>
            <h3>Disini kamu bakal menemukan sesuatu yang baru.<br> Teman baru, ilmu baru dan tentunya pengalam baru!</h3>
        </div>
      </div>
  </div>
...
<div class="row">
 ...
 <div class="col-lg-4">
    <div class="card mt-5">
     <div class="card-body">
    <h5 class="card-title"><a href="http://localhost:8000/topik/detail/{{$materi->slug}}">{{ Str::limit($materi->judul) }} </a></h5>
    <h6 class="card-subtitle mb-2 text-muted"> {{date('j F Y', strtotime($materi->created_at))}} by {{$materi->dari}}</h6>
  </div>
</div>
</div>
@endforeach
